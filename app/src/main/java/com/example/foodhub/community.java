...
public class community extends AppCompatActivity {
    ...
    private void displayRecipes(String jsonData) {
        Button thumbsUpButton = null;
        Button thumbsDownButton = null;
        try {
            ...
            for (int i = 0; i < recipesArray.length(); i++) {
                ...
                thumbsUpButton = recipeView.findViewById(R.id.up_vote_button);
                thumbsDownButton = recipeView.findViewById(R.id.down_vote_button);
                ...
                TextView authorNameTextView = recipeView.findViewById(R.id.profilename);
                ImageView profileImageView = recipeView.findViewById(R.id.profilepic);
        ...
        thumbsUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Send request to server to increment thumbs up count for this recipe
                // You can use AsyncTask or any networking library to make the request
        ...
        thumbsDownButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Send request to server to increment thumbs down count for this recipe
                // You can use AsyncTask or any networking library to make the request
                // Update the UI accordingly
            }
        });
    ...
    private class AddCommentTask extends AsyncTask<Void, Void, String> {
        ...
        @Override
        protected String doInBackground(Void... voids) {
            String apiUrl = "https://lamp.ms.wits.ac.za/home/s2709514/addcomment.php";
            RequestBody requestBody = new FormBody.Builder()
                    .add("recipe_id", String.valueOf(recipeId))
                    .add("user_id", String.valueOf(userId))
